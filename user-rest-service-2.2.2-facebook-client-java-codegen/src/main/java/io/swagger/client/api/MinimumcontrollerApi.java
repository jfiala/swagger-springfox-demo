...
public class MinimumcontrollerApi {
   ...
   * @return MinimumUser
   */
  public MinimumUser getUserUsingGET (Long id, String test) throws ApiException {
    Object postBody = null;
    byte[] postBinaryBody = null;
     ...
     if (test == null) {
        throw new ApiException(400, "Missing the required parameter 'test' when calling getUserUsingGET");
     }
    ...
    queryParams.addAll(apiClient.parameterToPairs("", "test", test));
